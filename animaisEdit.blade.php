...
<div class="mb-3">
    <label for="disableTextInput" class="form-label">Informe o novo ID do Tutor</label>
    <input type="text" id="disableTextInput" name="Id_Tutor" class="form-control" value="{{$animal->Id_Tutor}}">
</div> 
<div class="mb-3">
